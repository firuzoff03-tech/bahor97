...
app.get("/styles.css",c=>{c.header("Content-Type","text/css; charset=utf-8");return c.body(CSS)});
app.get("/app.js",c=>{c.header("Content-Type","application/javascript; charset=utf-8");return c.body(JS)});
